...
def item_detail(request, pk):
    ...
    # -------- захист від накруток переглядів через cookies --------
    ...
    # -------- оновлення історії переглядів у сесії --------
    ...
    # -------- встановлення cookies для захисту від накруток --------
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if staff_emails:
                ...
                url = request.build_absolute_uri(reverse('admin:bns_goiteens_app_categoryrequest_change', args=(cat_req.pk,)))
